...
pub(crate) use jsonl::append_attention_runtime_trace_jsonl;
...
mod tests {
    use super::{
        ...
        AttentionRuntimeTraceMetadata, collect_attention_runtime_trace_with_enrichment,
        parse_attention_runtime_trace_jsonl, render_attention_runtime_trace_jsonl,
    };
