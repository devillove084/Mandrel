...
export MANDREL_VORTEX_REALIZATION_PROFILE="verilator_rtlsim"
export MANDREL_VORTEX_RTLSIM_CONFIGS="-DSIMULATION -DSV_DPI"
export MANDREL_VORTEX_CONFIG_MANIFEST="$MANDREL_VORTEX_BUILD_DIR/mandrel/vortex-config.json"
export MANDREL_VORTEX_CONFIG_SHA256_FILE="$MANDREL_VORTEX_BUILD_DIR/mandrel/vortex-config.sha256"
export MANDREL_VORTEX_CONFIG_TAG_FILE="$MANDREL_VORTEX_BUILD_DIR/mandrel/vortex-config.tag"
